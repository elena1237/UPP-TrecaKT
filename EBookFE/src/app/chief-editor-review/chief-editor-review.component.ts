...
@Component({
  selector: 'app-chief-editor-review',
  templateUrl: './chief-editor-review.component.html',
  styleUrls: ['./chief-editor-review.component.css']
})


export class ChiefEditorReviewComponent implements OnInit {
  ...
  constructor(private userService : UserService,private regService : RegistrationService, private repositoryService : RepositoryService, private router: Router) {
    ...
    let x = repositoryService.getFormForReview(localStorage.getItem("newpi"));
